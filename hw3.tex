...
\begin{proof} By induction. \\
    ...
    \begin{align*}
        ...
        \prod_{i=2}^{k+1}{1-\frac{1}{i^2}} &= \paren*{\frac{k+1}{2k}}\paren*{\frac{(k+1)^2 - 1}{(k+1)^2}} \\
                                           ...
                                           &= \frac{(k + 1) + 1}{2(k+1)} 
    \end{align*} 
    $\displaystyle\paren*{\prod_{i=2}^{k}{1-\frac{1}{i^2}}}\paren*{1-\frac{1}{(k+1)^2}}$, which is equivalent to $\displaystyle\prod_{i=2}^{k+1}{1-\frac{1}{i^2}}$, evaluates to $\df{(k + 1) + 1}{2(k+1)}$. Thus, $P(k) \implies P(k+1)$. \\
    \\
